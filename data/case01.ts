...
export const QUESTION_ONE_HINTS = [
  "히스토리에서 평범한 일상 사이트와 성격이 다른 검색어를 찾아보세요.",
  "NetScope에서 ‘아이s’를 검색하고 여러 일반 웹 검색 결과를 비교해보세요.",
  "OnionScope에 입력해서 마약 사이트인지 확인하고 입력한다.",
];

export const QUESTION_TWO_HINTS = [
  "1번에서 확인한 공식 주소를 OnionScope에서 열어두세요.",
  "Sources의 index.html에서 연결된 외부 JavaScript 파일을 열고 코드 정리 기능을 사용하세요.",
  "atob()으로 Base64를 풀고, 숫자 배열에서 만든 반복 키와 XOR하는 흐름을 따라가세요.",
];

export const QUESTION_THREE_HINTS = [
  "문제 2에서 확보한 G-로 시작하는 식별 값을 SourceScope에 그대로 입력하세요.",
  "검색 결과의 복사 게시물·분석 문서·아카이브보다 운영 주체가 직접 관리한 사이트를 찾아보세요.",
  "raclog.kr을 NetScope에서 열고 홍보 게시물 아래의 사업자 라이선스 정보를 확인하세요.",
];

export const QUESTION_FOUR_HINTS = [
  "문제 3에서 확인한 가명을 NetScope에 검색하세요.",
  "검색 결과의 미리보기에는 지갑 주소가 없습니다. 게시물을 하나씩 열어 후원 주소를 비교하세요.",
  "너굴상점의 비트코인 입금 주소와 일치하는 글의 작성자 프로필을 확인하세요.",
];

export const QUESTION_FIVE_HINTS = [
  "로그에서 너굴상점 지갑으로 1.00000000 BTC가 전송된 거래들을 먼저 추리세요.",
  "각 결제 거래의 입력 지갑이 같은 3일치 로그에서 이전 거래의 Out으로 등장하는지 확인하세요.",
  "세 중간 지갑으로 자금을 분배한 거래까지 거슬러 올라가, 10.50000000 BTC를 입력한 단일 지갑을 찾으세요.",
];

export const QUESTION_SIX_HINTS = [
  "문제 5에서 확인한 믹서 지갑을 목적지(Out)로 사용하는 거래만 먼저 추출하세요.",
  "추출된 거래의 In 주소들을 정규식이나 awk·sed로 분리해 중복 없는 집합으로 만드세요.",
  "In 주소 집합과 suspect_wallet_mapping.csv의 wallet_address 열을 교차 대조한 뒤, 일치한 이름을 가나다순으로 제출하세요.",
];
